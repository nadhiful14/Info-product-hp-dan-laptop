  ...
  <div class="col-md-9 rmvpad"> 
    ...
    <div class="jarak">
          ...
          <div>
            <form action="proses_tambah.php" method="post" enctype="multipart/form-data">
              ...
              <tr>
                ...
                <td class="baris" ><?php echo $hape['nama']; ?><br/> </td>
              </tr>
              ...
              <tr>
                ...
                <td class="baris"><?php echo $hape['cpu']; ?><br/></td>
              </tr>
              <tr>
                <td>
                GPU
                </td>
                <td class="baris"> <?php echo $hape['gpu']; ?></td>
              </tr>
              <tr>
                <td>
                Kamera Belakang
                </td>
                <td class="baris"> <?php echo $hape['kamera']; ?></td>
              </tr>
              <tr>
                <td>
                Kamera Depan
                </td>
                <td class="baris"> <?php echo $hape['kamera_depan']; ?></td>
              </tr>
              <tr>
                <td>
                RAM
                </td>
                <td class="baris"> <?php echo $hape['ram']; ?></td>
              </tr>
              <tr>
                <td>
                Storage
                </td>
                <td class="baris"><?php echo $hape['storage']; ?></td>
              </tr>
              <tr>
                <td>
                Android Version
                </td>
                <td class="baris"><?php echo $hape['os']; ?></td>
              </tr>
              <tr>
                <td>
                  ROM
                </td>
               <td  class="baris"><?php echo $hape['rom']; ?></td>
              ...
              <tr>
                ...
                <td class="baris"><?php echo $hape['layar']; ?></td>
              </tr>
              ...
              <tr>
                ...
                <td class="baris"><?php echo $hape['baterai']; ?></td>
              </tr>
              <tr>
                <td style="text-align:top">
                Fitur
                </td>
                <td class="baris"><?php $chk = unserialize($hape['fitur']);
                    foreach ($chk as $key) { 
                    echo "$key".", ";
                  }
                ?></td>
              ...
              <tr>
                ...
                <td class="baris"><?php echo $hape['harga']; ?></td>
              </tr>
      ...
      <div class="col-md-5 col-sm-5 col-xs-5 konteen" >
        <<img class="foto"  width="100%" height="300px" src="img/<?php echo $hape["gambar"]?>">
